...
struct ImGuiWindowClass
{
    ...
    ImGuiWindowClass()
    {
        ClassId = 0; ParentViewportId = 0; ViewportFlagsOverrideSet = ViewportFlagsOverrideClear = 0x00; DockNodeFlagsOverrideSet = DockNodeFlagsOverrideClear = 0x00; DockingAlwaysTabBar = false; DockingAllowUnclassed = true;
    }
};
...
namespace ImGui
{
    ...
    static inline bool  OpenPopupOnItemClick(const char* str_id = NULL, ImGuiMouseButton mb = 1)
    {
        return OpenPopupContextItem(str_id, mb);
...
struct ImDrawList
{
    ...
    {
        _Data = shared_data; Flags = ImDrawListFlags_None; _VtxCurrentIdx = 0; _VtxWritePtr = NULL; _IdxWritePtr = NULL; _OwnerName = NULL;
    }
...
struct ImDrawData
{
    ...
    void Clear()
    {
        Valid = false; CmdLists = NULL; CmdListsCount = TotalVtxCount = TotalIdxCount = 0; DisplayPos = DisplaySize = FramebufferScale = ImVec2(0.f, 0.f); OwnerViewport = NULL;
...
struct ImGuiPlatformMonitor
{
    ...
    {
        MainPos = MainSize = WorkPos = WorkSize = ImVec2(0, 0); DpiScale = 1.0f;
    }
};
...
struct ImGuiViewport
{
    ...
    ImVec2              GetWorkPos()
    {
        return ImVec2(Pos.x + WorkOffsetMin.x, Pos.y + WorkOffsetMin.y);
    }
    ImVec2              GetWorkSize()
    {
